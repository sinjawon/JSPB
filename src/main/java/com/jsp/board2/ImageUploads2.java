...
//	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		while (true)
			try {
				String imageName2 = RandomStringGenerator.generateRandomString(10);
				...
				try (DBConnector con = new DBConnector();) {
					...
					System.out.println(imageName2);
					 ...
					 map.saveImage2(String.join("/", req.getParameter("year"), req.getParameter("month"), req.getParameter("day"),imageName2 +token), boardListNum2);
						
					 
					 System.out.println(String.join("/", req.getParameter("year"), req.getParameter("month"), req.getParameter("day"),imageName2)+token);
