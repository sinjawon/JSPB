...
public interface BoardDao {
 ...
 // BoardDao.java 파일의 insertNewBoard 메서드 수정
 	@Insert("insert into boardInfo (boardListNum, title, mainContents, userNickname, hitCount, regDate, image1, image2, image3, image4) values (seqBoardListNum.nextval, #{title}, #{mainContents}, #{userNickname}, 0, sysdate, #{image1, jdbcType=VARCHAR}, #{image2, jdbcType=VARCHAR}, #{image3, jdbcType=VARCHAR}, #{image4, jdbcType=VARCHAR})")
 	public void insertNewBoard(@Param("userNickname") String userNickname, @Param("title") String title, @Param("mainContents") String mainContents, @Param("image1") String image1, @Param("image2") String image2, @Param("image3") String image3, @Param("image4") String image4);
   //지수-새로운 글을 추가하는 메서드. 
   ...
   @Insert("insert into boardInfo (boardListNum, title, mainContents, userNickname, hitCount, regDate, image1, image2, image3, image4) values (seqBoardListNum.nextval, #{title}, #{mainContents}, #{userNickname}, 0, sysdate, #{images[0]}, #{images[1]}, #{images[2]}, #{images[3]})")
   public void insertNewBoard(@Param("userNickname") String userNickname, @Param("title") String title, @Param("mainContents") String mainContents, @Param("images") String[] images);
   //-----------------
