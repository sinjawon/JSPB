...
//	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		while (true)
			try {
				String imageName3 = RandomStringGenerator.generateRandomString(10);
				...
				try (DBConnector con = new DBConnector();) {
					...
					System.out.println(imageName3);
					 ...
					 System.out.println(String.join("/", req.getParameter("year"), req.getParameter("month"), req.getParameter("day"),imageName3)+token);
