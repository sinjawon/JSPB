	...
	<div class="swiper mainslide">
		<div class="swiper-wrapper">
			<div class="swiper-slide">
				<a href="boardlist.jsp"><img class="image"
					src="/resources/mainbanner08_sub.jpg" alt="자유" /></a>
				<div class="subTitle">
					<h2>자유게시판</h2>
				</div>
			</div>
			<div class="swiper-slide">
				<a href="boardlist2.jsp"><img class="image"
					src="/resources/mainbanner02.sub.jpg" alt="자랑" /></a>
				<div class="subTitle">
					<h2>자랑게시판</h2>
				</div>
			</div>
			<div class="swiper-slide">
				<a href="boardlist3.jsp"><img class="image"
					src="/resources/mainbanner06_sub.jpg" alt="산책" /></a>
				<div class="subTitle">
					<h2>산책게시판</h2>
				</div>
			</div>
			<div class="swiper-slide">
				<a href="boardlist4.jsp"><img class="image"
					src="/resources/mainbanner07_sub.jpg" alt="정보" /></a>
				<div class="subTitle">
					<h2>애완용품거래</h2>
				</div>
			</div>
			<div class="swiper-slide">
				<a href="joinmembership.jsp"><img class="image"
					src="/resources/mainbanner05_sub.jpg" alt="기타 " /></a>
				<div class="subTitle">
					<h2>회원가입</h2>
				</div>
			</div>
						...
						<div id="boards" class="boards">
							...
							<form id="searchform" action="/api/boardlist" method="post"
								...
								<select id="searches" name="searchtype">
									...
									type="text" id="page" name="page" value="1"
									style="display: none;" />
								<button type="button" onclick="submitSearch()" class="searchBtn">검색</button>
							</form>
						</div> <!-- <div class="free-title">자유게시판 제목</div>
					...
					<a class="free-a" href="#home">
						<div id="boards3" class="boards">
							<template>
								<div class="board">
									<div class="NumBox">
										<a href="/app/postview3.jsp?id=0"
											class="boardListNum3 boardListNum">0</a>
									</div>
									<div>
										<div class="titleBox">
											<a href="/app/postview3.jsp?id=0" class="title3 title">제목</a>
										</div>
										<div class="board_contents">
											<a class="mainContents3 mainContents" style="display: none;">본문</a>
										</div>
									</div>
									<div class="writer">
									...
									<div class="hitCountBox">
										<a class="hitCount3 hitCount" style="display: none;">조회수</a>
									</div>
									<div class="date">
										<a class="regDate3 regDate" style="display: none;">등록일</a>
									</div>
								</div>
							</template>
						</div>

						<form id="searchform3" class="searchform" action="/api/boardList3"
							...
							</select> <input type="text" id="search3" name="search3"> <input
								type="text" id="page3" name="page3" value="1"
								style="display: none;" />
				...
				<a class="free-a" href="#home">
					<div id="boards2" class="boards">
						<template>
							<div class="board">
								<div class="NumBox">
									<a href="/app/postview2.jsp?id=0"
										class="boardListNum2 boardListNum">0</a>
								</div>
								<div>
									<div class="titleBox">
										<a href="/app/postview2.jsp?id=0" class="title2 title">제목</a>
									</div>
									<div class="board_contents">
										<a class="mainContents2 mainContents" style="display: none;">본문</a>
									</div>
								</div>
								<div class="writer">
								...
								<div class="hitCountBox">
									<a class="hitCount2 hitCount" style="display: none;">조회수</a>
								</div>
								<div class="date">
									<a class="regDate2 regDate" style="display: none;">등록일</a>
								</div>
							</div>
						</template>
					</div>

					<form id="searchform2" class="searchform" action="/api/boardList2"
						method="post" style="display: none">
						...
						</select> <input type="text" id="search2" name="search2"> <input
							type="text" id="page2" name="page2" value="1"
							style="display: none;" />
 ...
 --%>
	...
	<c:if test="${sessionScope.UserNickName!=null }">
		<div style="position: fixed; bottom: 4.7rem; right: 3.5rem;">
			...
			<iframe src="./messagebox.jsp"
				style="position: fixed; bottom: 7rem; right: -2rem; width: 25rem; height: 40rem; z-index: 1;">></iframe>
