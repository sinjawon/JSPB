...
<body>
	...
	<form action="/app/boardlist3.jsp" method="post">
		<button type="submit">뒤로가기</button>
	</form>


	<div id="replyContainer3">
		<template>
			<div class="userNickname3">작성자</div>
			<div class="replyContents3">본문</div>
			<div class="regDate3">등록일</div>
	...
	<form id="replyForm3" action="/api/addReply3" method="post">
		...
		<br> <input type="text" id="userNickname3" name="userNickname3"
			value="<%=session.getAttribute("UserNickName")%>"
			placeholder="작성자 닉네임"> <br>
		<br>
		<textarea id="replyContents3" name="replyContents3" placeholder="댓글 내용"></textarea>
		<br>
		<br>
		<button type="button" id="addReplyBtn3">등록</button>
	</form>
