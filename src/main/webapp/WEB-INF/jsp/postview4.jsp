...
<body>
	...
	<div class="detail">
	<h3>애완용품거래</h3>
	<div class="detail_board detail_board4 " >
		<div>
		...
		<div>
			<div id="viewTextarea4" class="viewTextarea">글 내용</div>
		</div>
	</div>
	...
	<div id="replyContainer4"  class="modi_btn">
		<template>
			<div class="replyWrap">
				<div>
					<div class="userNickname4 userNicname">작성자</div>
					<div class="regDate4 regDate">등록일</div>
				</div>
