...
<body>
	...
	<form id="searchform" action="/api/boardList" method="post">
		<select id="searches" name="searchtype">
			...
			type="text" id="page" name="page" value="1" style="display: none;" />
	...
	<form id="refresh" action="/api/boardList" method="post">
		<button type="button" class="back"
			onClick="location.href='/app/boardlist.jsp'">목록으로 돌아가기</button>
	</form>
	<form action="/insert" method="post">
		<button type="button" class="navyBtn"
			onClick="location.href='/app/insert.jsp'">글쓰기</button>
	</form>
